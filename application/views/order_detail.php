           ...
           <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
               <div class="box p-5 rounded-md">
                   ...
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Order ID:</b> <a href=""
                           class="underline decoration-dotted ml-1">#<?= $invoice->order_id ?></a>
                   </div>
                   <div class="flex items-center mt-3"> <i data-lucide="clipboard"
                           class="w-4 h-4 text-slate-500 mr-2"></i> <b>Payment Method:&nbsp;</b> Direct Bank Transfer
                   </div>
                   <div class="flex items-center mt-3"> <i data-lucide="calendar"
                           class="w-4 h-4 text-slate-500 mr-2"></i> <b>Purchase Date:&nbsp;</b>
               ...
               <div class="box p-5 rounded-md mt-5">
                   ...
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Customer Name:</b> <a href=""
                           class="underline decoration-dotted ml-1"><?= $invoice->name ?></a>
                   </div>
                   <div class="flex items-center mt-3"> <i data-lucide="calendar"
                           class="w-4 h-4 text-slate-500 mr-2"></i> <b>Phone Number:</b>&nbsp;
                       <?= $invoice->mobile_phone ?> </div>
               </div>
               <div class="box p-5 rounded-md mt-5">
                   <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
                       <div class="font-medium text-base truncate">Shipping Information</div>
                       <a href="https://cekresi.com/" class="flex items-center ml-auto text-primary"> <i
                               data-lucide="map-pin" class="w-4 h-4 mr-2"></i> Tracking Info </a>
                   </div>
                   <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                       <b>Courier:</b>&nbsp; <?= $invoice->ekspedisi ?>
                   </div>
                   <div class="flex items-center mt-3"> <i data-lucide="calendar"
                           class="w-4 h-4 text-slate-500 mr-2"></i> <b>Nomer Resi:</b>&nbsp;
                       <?= $invoice->tracking_id ?> <i data-lucide="copy" class="w-4 h-4 text-slate-500 ml-2"
                           onclick="copyToClipboard('<?= $invoice->tracking_id ?>')"></i>
                   </div>

                   <div class="flex items-center mt-3"> <i data-lucide="map-pin"
                           class="w-4 h-4 text-slate-500 mr-2"></i> <b>Address:</b>&nbsp;
                       <small><?= $invoice->alamat ?>, <?= $invoice->city ?>.</small>
                   </div>
               </div>
           </div>
