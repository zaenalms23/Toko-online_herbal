            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                <div class="box">
                    ...
                    <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                          <a class="flex items-center btn btn-sm btn-warning text-white mr-3" href="<?php echo base_url('home/detail_product/' . $row->id_brg) ?>" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal"> <i data-lucide="info" class="w-4 h-4 mr-1"></i> Detail </a>
                        <a class="flex items-center btn btn-sm btn-success mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal"> <i data-lucide="shopping-cart" class="w-4 h-4 mr-1"></i> Add to Cart </a>
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    <i data-lucide="alert-circle" class="w-16 h-16 text-success mx-auto mt-3"></i> 
                ...
                <div class="px-5 pb-8 text-center">
                    ...
                    <a href="<?= site_url('welcome')?>" class="btn btn-success w-24">Login</a>
                </div>
            </div>
        </div>
    </div>
