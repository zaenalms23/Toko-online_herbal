        ...
        <div class="col-span-12 lg:col-span-12 2xl:col-span-8">
            <div class="box p-5 rounded-md">
                <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
                    ...
                    <a href="<?= site_url('dashboard/checkout') ?>"
                        class="flex items-center ml-auto btn btn-primary shadow-md mr-2"><i data-lucide="activity"
                            class="w-4 h-4 mr-2"></i>&nbsp;CHECKOUT </a>
                </div>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <!-- Menambahkan kolom untuk aksi penambahan qty -->
                            </tr>
                        </thead>
                        <tbody>
                            <?php $no = 1;
                            ...
                            <tr>
                                <td><a href="<?= site_url('dashboard/delete/' . $items['rowid']) ?>"><i
                                            data-lucide="trash-2" class="w-4 h-4"></i></a></td>
                                <td class="!py-4">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="Midone - HTML Admin Template"
                                                class="rounded-lg border-2 border-white shadow-md tooltip"
                                                src="<?= base_url() . '/uploads/' . $items['options']['gambar']; ?>"
                                                title="Uploaded at 8 December 2021">
                                        </div>
                                ...
                                <td class="text-right">
                                    <div class="flex items-center">
                                        <a href="<?= site_url('dashboard/decrease_qty/' . $items['rowid']) ?>" class="
                                            <div class=" flex items-center">
                                            <a href="<?= site_url('dashboard/decrease_qty/' . $items['rowid']) ?>"
                                                class="btn btn-sm btn-secondary">-</a>
                                            <span class="mx-2"><?= $items['qty']; ?></span>
                                            <a href="<?= site_url('dashboard/increase_qty/' . $items['rowid']) ?>"
                                                class="btn btn-sm btn-primary">+</a>
                                    </div>
                                </td>
                                <td class="text-right">Rp. <?= number_format($items['subtotal'], 0, ',', '.') ?></td>
                                <td class="text-right">
                                    <a href="<?= site_url('dashboard/delete/' . $items['rowid']) ?>"><i
                            ...
                            <tr>
                                ...
                                <td class="text-right"><strong>Rp.
                                        <?= number_format($this->cart->total(), 0, ',', '.') ?>,-</strong></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
